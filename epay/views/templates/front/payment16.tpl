...
<div class="epay_paymentwindow_container">
    ...
    <script type="text/javascript" src="https://relay.ditonlinebetalingssystem.dk/integration/paymentlogos/PaymentLogos.aspx?merchantnumber={$epayMerchant|escape:'htmlall':'UTF-8'}&direction=2&padding=2&rows=1&logo=0&showdivs=0&divid=epay_card_logos"></script>
</div>
