...
<section>
	<div class="epay_section_container">
		...
		<div id="epay_paymentlogos">
			<script type="text/javascript" src="https://relay.ditonlinebetalingssystem.dk/integration/paymentlogos/PaymentLogos.aspx?merchantnumber={$merchantNumber|escape:'htmlall':'UTF-8'}&direction=2&padding=2&rows=1&logo=0&showdivs=0&cardwidth=45&divid=epay_paymentlogos"></script>
		</div>
	</div>
</section>
